...
import "contracts/Governance/LPTokenWrapper.sol";
...
contract CartallosGovernance is LPTokenWrapper{
    ...
    IBEP20 public token; //yCRV token
...
/* TODO
*IMPORTANT*
Integrate check to ensure caller is reward distribution
*/
    function notifyRewardAmount(uint256 reward)
        external
        updateReward(address(0))
    {
        IBEP20(token).safeTransferFrom(msg.sender, address(this), reward);
